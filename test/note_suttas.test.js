...
test('output note for SN 12.48 to Notes/Suttas/SN 12.48.md when file does not exist', async () => {
    const options = {
        sutta: 'SN 12.48',
        output_directory: '~/Obsidian/Vaults/Ignacio/Ignacio/Suttas/'
    };
    ...
    expect(fs.writeFileSync).toHaveBeenCalledWith('~/Obsidian/Vaults/Ignacio/Ignacio/Suttas/SN 12.48.md', sutta_contents);
